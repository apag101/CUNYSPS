...
#Show howt create a numeric vector that contains the sequence from 20 to 50 by 5
fives <- seq(20,50,5)
fives

#Create the function "factorial" that takes a trio of input numbers a, b, c and solve the quadratic
#equation. The function should print as output the 2 solutions
