...
- Library
    ...
    - 2 ways to initiate:
        ...
        * ggplotly() function totransforms a ggplot object into a plotly
        * ggplotly has a dependency on ggplot2 while plot_ly does not
...
```{r example3, echo= TRUE, message=FALSE, warning=FALSE}
...
```{r example4, echo= TRUE, message=FALSE, warning=FALSE}
library(plotly)
library(GGally)
pm<- ggpairs(iris)
...
```{r plotlyonline, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
...
```{r plotlydownload, echo=TRUE, message=FALSE, warning=FALSE}
...
- app.R has three components:
    ...
    - UI is the user interface object
...
```{r shiny1, echo=TRUE, message=FALSE, warning=FALSE}
library(shiny)
...
```{r shinyplotly, echo=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
...
##Recap
 ...
 - Both Shiny and Plotly can be use for interactive plots
 - Plotly used for data frames
 - Shiny is a app renderer and can be used to build web pages
 - Shiny and Plotly can be used together
