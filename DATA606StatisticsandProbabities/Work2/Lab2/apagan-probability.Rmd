---
title: "Probability"
subtitle: "Lab2 Completed (Anthony Pagan)"
output:
  html_document:
    theme: cerulean
    highlight: pygments
...
######$\color{red}{\text{A streak means there was a hit.  A streak of 1 means there was 1 shot hit.A streak of 0 means there was a missed shot followed by 0 hit shots.}}$
...
######$\color{red}{\text{Kobe had more 1 hit or miss streaks then multiple hits. His longest streak of hits was 4}}$
...
######$\color{red}{\text{As expected ~45% of 133 will have a Hit shot.}}$

```{r eval=TRUE}
sim_basket.streak <- calc_streak(sim_basket)
barplot(table(sim_basket.streak))
```
    
    
-   How long is the player's longest streak of baskets in 133 shots?

######$\color{red}{\text{The longest streak was `r table(sim_basket.streak)[dim(table(sim_basket.streak))]`}}$

-   If you were to run the simulation of the independent shooter a second time,how would you expect its streak distribution to compare to the distribution from the question above? Exactly the same? Somewhat similar? Totally different? Explain your reasoning.

######$\color{red}{\text{If this simulation ran serveral times i would expect the distribution to be similar, but not the same.  The Law of Large numbers will take hold as the number of trials increase the results will trend closer to means.}}$
...
######$\color{red}{\text{I would expect the two will be similar. I dont believe the hot hand fits Kobe's pattern. Eventually all players shooting perecentages will fall within their longterm average, a hot hand is just percentages working out as epxected.}}$
