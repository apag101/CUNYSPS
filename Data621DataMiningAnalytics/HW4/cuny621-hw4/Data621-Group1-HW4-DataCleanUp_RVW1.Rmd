...
InsTrain$predicted_m4<- predict(m4, InsTrainM4, type='response')
...
This model shows an adj R2 as 0.28, and F-statistic of 87.86 with a small p-value.
...
This model shows an adj R2 as 0.056, and F-statistic of 22.86 with a small p-value.
...
This model shows an adj R2 as 0.055, and F-statistic of 32.86 with a small p-value.
