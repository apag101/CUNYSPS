...
As revealed earlier there were a list of columns with  factors that should be integers. We start by converting the columns to numeric.
...
summary(m1)
b<-regsubsets(TARGET_FLAG~.-INDEX-TARGET_FLAG-TARGET_AMT,data=InsTrain)
rs<-summary(b)
rs$which
