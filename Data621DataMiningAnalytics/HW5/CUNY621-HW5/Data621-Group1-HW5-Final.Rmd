...
WineTrain <- read.csv("https://raw.githubusercontent.com/pkowalchuk/CUNY621-HW5/master/wine-training-data.csv",fileEncoding="UTF-8-BOM",na.strings="",header=TRUE)
WineTrain1 <- WineTrain
WineEval <- read.csv("https://raw.githubusercontent.com/pkowalchuk/CUNY621-HW5/master/wine-evaluation-data.csv",fileEncoding="UTF-8-BOM",na.strings="",header=TRUE)
```
