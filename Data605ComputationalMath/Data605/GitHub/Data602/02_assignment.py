...
def exercise01():
    ...
    animals = ["cat", "dog", "croucing tiger", "hidden dragon", "manta ray"]
...
def exercise09():
    ...
    # ------ Place code below here \/ \/ \/ ------
    dogs.append(['https://www.pexels.com/photo/adorable-animal-breed-canine-356378/',
                'https://www.pexels.com/photo/black-and-brown-short-haired-puppy-in-cup-39317/',
                'https://www.pexels.com/photo/animal-dog-pet-labrador-8700/',
                'https://www.rover.com/blog/pet-ramps',
                'https://www.pexels.com/photo/close-up-photography-of-adult-black-and-white-short-coat-dog-733416/',
                ...
                'https://www.pexels.com/photo/adorable-animal-breed-canine-434090/'])
    # ------ Place code above here /\ /\ /\ ------
